                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="{{ route('admin-kategori-post') }}">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="inputPassword3">Nama Kategori</label>
                                                                <input type="text" class="form-control" name="kategori_usaha">
                                                            </div>
                                                        </div>
                                                ...
                                                <table id="example" class="table table-bordered" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('admin-kategori-edit', $item->id) }}"><i class="text-muted fas fa-pencil-alt ml-2 mr-3"></i></a>
                                                                <button>
